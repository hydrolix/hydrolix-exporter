...
docker run -it --rm \
  ...
  -e HYDROLIX_ENDPOINT="https://my-cluster.hydrolix.live/ingest/event" \
...
exporters:
  hydrolix:
    endpoint: https://my-cluster.hydrolix.live/ingest/event  # Hydrolix ingest endpoint
    hdx_table: my-org.metrics                              # Target table
    hdx_transform: tf_otel_metrics                    # Transform name
